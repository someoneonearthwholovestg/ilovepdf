...
class Database:
    ...
    async def get_all_users(self) -> AsyncIOMotorCursor:
        ...
        Returns:
            AsyncIOMotorCursor: An asynchronous AsyncIOMotorCursor for the users collection.
        """
    ...
    async def get_all_chats(self) -> AsyncIOMotorCursor:
        ...
        Returns:
            AsyncIOMotorCursor: An asynchronous AsyncIOMotorCursor for the groups collection.
        """
